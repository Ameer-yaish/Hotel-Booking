...
module.exports.getPlace= async(req,res,next)=>{
    try{
        const id=req.params.id
        const wantedRoom = await Room.findById(id,{feedbacks:1,imgs:1,features:1,disCount:1,averageRating:1,desc:1,maxPeople:1,price:1,title:1,city:1,type:1,destanceFromCityCenter:1})
